...
// fields and helpers (Review.ProfileLink, Review.ReviewId, Review.OwnerResponse,
// mergeUniqueReviews) that no longer exist on the current Review type. The
// tests were written against an older shape and have not been updated.
//
