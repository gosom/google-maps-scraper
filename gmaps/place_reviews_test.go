...
// fields and helpers (Review.ReviewId, mergeUniqueReviews) that no longer
// exist on the current Review type. The tests were written against an older
// shape and have not been updated.
//
